    ...
    <div x-data="WireChatDialog()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        <div class="flex items-end  justify-center min-h-screen px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            ...
            <div x-show="show && showActiveDialogComponent" 
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $dialogComponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div  x-show.immediate="activeDialogComponent == '<?php echo e($id); ?>'" x-ref="<?php echo e($id); ?>"
...
<?php /**PATH /home/cainan/Documents/wirechat-app/vendor/namu/wirechat/src/../resources/views/livewire/modals/chat-dialog.blade.php ENDPATH**/ ?>