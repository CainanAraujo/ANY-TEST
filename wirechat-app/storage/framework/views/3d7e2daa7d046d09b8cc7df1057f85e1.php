<div id="info-modal" class="bg-white dark:bg-gray-900 space-y-auto h-screen">
    ...
    <section class="flex gap-4 z-[10]  items-center p-5 sticky top-0 bg-white dark:bg-gray-900  ">
        ...
        <h3><?php echo e($group ? 'Group' : 'Chat'); ?> Info</h3>
    </section>
    ...
    <header>
        ...
        <!--[if BLOCK]><![endif]--><?php if($isGroup): ?>
           ...
           <!--[if BLOCK]><![endif]--><?php if($authIsAdminInGroup || $group->allowsMembersToEditGroupInfo()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'wirechat::components.avatar','data' => ['wire:loading.class' => 'cursor-not-allowed','group' => ''.e($isGroup).'','src' => ''.e($cover_url).'','class' => 'w-full h-full absolute inset-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:loading.class' => 'cursor-not-allowed','group' => ''.e($isGroup).'','src' => ''.e($cover_url).'','class' => 'w-full h-full absolute inset-0']); ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(empty($cover_url)): ?>
                ...
                <div class="space-y-3 grid  overflow-x-hidden">
                        ...
                        <form @dusk="edit_group_name_form" wire:submit="updateGroupName" x-data="{ editing: false }"
                            ...
                            <div class="   max-w-[90%] grid h-auto">
                                <div x-show="!editing">
                                    <h4 class="font-medium  break-all   whitespace-pre-line   text-2xl "> <?php echo e($groupName); ?> </h4>
                                </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['groupName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="text-red-500 inline"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <p class="mx-auto"> Members <?php echo e($totalParticipants); ?> </p>
                        ...
                        <div @dusk="edit_description_section" x-data="{ editing: false }" @click.outside="editing=false"
                            ...
                            <span class="col-span-11">
                                <div x-show="!editing">
                                    ...
                                    <?php else: ?>
                                        <p class="font-medium break-all   whitespace-pre-line "><?php echo e($description); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div @dusk="non_editable_group_information_section" class="flex  flex-col items-center gap-5 py-5 px-4  ">
                <?php if (isset($component)) { $__componentOriginal573e53ccc82ae542bef1ba188da3d396 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal573e53ccc82ae542bef1ba188da3d396 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'wirechat::components.avatar','data' => ['src' => ''.e($cover_url).'','class' => ' h-32 w-32 mx-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('wirechat::avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['src' => ''.e($cover_url).'','class' => ' h-32 w-32 mx-auto']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal573e53ccc82ae542bef1ba188da3d396)): ?>
<?php $attributes = $__attributesOriginal573e53ccc82ae542bef1ba188da3d396; ?>
...
<?php unset($__componentOriginal573e53ccc82ae542bef1ba188da3d396); ?>
<?php endif; ?>
                <h4 @dusk="group_name" class="font-medium  break-all   whitespace-pre-line   text-2xl "> <?php echo e($groupName); ?> </h4>
                <p class="mx-auto"> Members <?php echo e($totalParticipants); ?> </p>
                <p class="font-medium break-all   whitespace-pre-line "><?php echo e($description); ?> </p>
            </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <?php else: ?>
            ...
            <div class="flex  flex-col items-center gap-5 ">
                ...
                <div class="mx-auto items-center justify-center grid">
                    ...
                    <a href="<?php echo e($receiver->profile_url); ?>">
                        <?php if (isset($component)) { $__componentOriginal573e53ccc82ae542bef1ba188da3d396 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal573e53ccc82ae542bef1ba188da3d396 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'wirechat::components.avatar','data' => ['src' => ''.e($cover_url).'','class' => ' h-32 w-32 mx-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('wirechat::avatar'); ?>
...
<?php endif; ?>
                ...
                <div class=" grid  ">
                    ...
                    <a class="px-8 py-5 " @dusk="receiver_name" href="<?php echo e($receiver->profile_url); ?>">
                        <h5 class="text-2xl"><?php echo e($receiver?->display_name); ?></h5>
                    </a>
                </div>


                <p class="font-medium break-all px-8 py-5   whitespace-pre-line "><?php echo e($description); ?> </p>
    ...
    <?php if (isset($component)) { $__componentOriginal2f84e5798f1d1ee3bd12a08d876c838e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2f84e5798f1d1ee3bd12a08d876c838e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'wirechat::components.divider','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('wirechat::divider'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2f84e5798f1d1ee3bd12a08d876c838e)): ?>
<?php $attributes = $__attributesOriginal2f84e5798f1d1ee3bd12a08d876c838e; ?>
<?php unset($__attributesOriginal2f84e5798f1d1ee3bd12a08d876c838e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal2f84e5798f1d1ee3bd12a08d876c838e)): ?>
<?php $component = $__componentOriginal2f84e5798f1d1ee3bd12a08d876c838e; ?>
<?php unset($__componentOriginal2f84e5798f1d1ee3bd12a08d876c838e); ?>
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($isGroup): ?>
        <section class="my-4 text-left space-y-3">
            ...
            <button
                wire:click="$dispatch('openChatDialog', {component: 'members',arguments: { conversation: <?php echo e($conversation->id); ?> }})"
                class="flex w-full justify-between items-center px-8 focus:outline-none ">
                <span class="text-gray-600 dark:text-gray-300"> Members <?php echo e($totalParticipants); ?></span>
            ...
            <!--[if BLOCK]><![endif]--><?php if($authIsAdminInGroup || $group->allowsMembersToAddOthers()): ?>
            <button @dusk="open_add_members_modal_button" wire:click="$dispatch('openChatDialog', {component: 'add-members',arguments: { conversation: <?php echo e($conversation->id); ?> }})"
...
<?php endif; ?>
    ...
    <section class="flex flex-col justify-start w-full">
        ...
        <!--[if BLOCK]><![endif]--><?php if($isGroup && !$authIsOwner): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($isGroup && $authIsOwner): ?>
            ...
            <div>
                ...
                <button
                    wire:click="$dispatch('openChatDrawer', {component: 'permissions',arguments: { conversation: <?php echo e($conversation->id); ?> }})"
...
<?php /**PATH /home/cainan/Documents/wirechat-app/vendor/namu/wirechat/src/../resources/views/livewire/info/info.blade.php ENDPATH**/ ?>