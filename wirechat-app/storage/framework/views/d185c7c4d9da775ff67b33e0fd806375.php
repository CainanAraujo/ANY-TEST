...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['src' => null, 'story' => null, 'group' => false,'disappearing'=>false]));
...
foreach (array_filter((['src' => null, 'story' => null, 'group' => false,'disappearing'=>false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div
    ...
    <!--[if BLOCK]><![endif]--><?php if($src): ?>
        <img  loading="lazy" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
            'shrink-0 w-full h-full object-cover object-center rounded-full',
        ]); ?>" src="<?php echo e($src); ?>" />
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

    <!--[if BLOCK]><![endif]--><?php if(!$src && $group): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($disappearing): ?>
...
<?php /**PATH /home/cainan/Documents/wirechat-app/vendor/namu/wirechat/src/../resources/views/components/avatar.blade.php ENDPATH**/ ?>