...
<header class="px-3 z-10  sticky top-0 w-full py-2  ">
    ...
    <section class=" justify-between flex items-center mb-4  pb-2">
        ...
        <div class="flex gap-x-3 items-center  ">
            ...
            <!--[if BLOCK]><![endif]--><?php if(WireChat::showNewChatModalButton() == true): ?>
            ...
            <a id="redirect-button" href="<?php echo e(config('wirechat.home_route', '/')); ?>" class="flex items-center">
...
<?php /**PATH /home/cainan/Documents/wirechat-app/vendor/namu/wirechat/src/../resources/views/components/chats/header.blade.php ENDPATH**/ ?>